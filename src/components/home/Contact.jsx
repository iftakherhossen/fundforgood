...
const Contact = () => {
    ...
    return (
        <section id="contact" className="container mx-auto py-20 flex flex-col gap-5">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-8 p-5">
                        ...
                        <form id="contactForm" className="flex flex-col gap-4" onSubmit={handleSendMessage}>
                            <div>
                                ...
                                <input type="text" id="name" className="bg-gray-50 border border-gray-100 lg:text-lg font-medium text-gray-900 rounded-lg w-full px-4 py-2.5 focus:ring-0 focus:border-gray-300" placeholder="John Doe" value={contactData?.name} onChange={handleOnChange}  required />
                            </div>
                            <div>
                                <label htmlFor="email" className="block mb-2 font-semibold text-gray-900">Email</label>
                                <input type="email" id="email" className="bg-gray-50 border border-gray-100 lg:text-lg font-medium text-gray-900 rounded-lg w-full px-4 py-2.5 focus:ring-0 focus:border-gray-300" placeholder="johndoe@email.com" value={contactData?.email} onChange={handleOnChange} required />
                            </div>
                            <div>
                                <label htmlFor="message" className="block mb-2 font-semibold text-gray-900">Message</label>
                                <textarea id="message" className="bg-gray-50 border border-gray-100 lg:text-lg font-medium text-gray-900 rounded-lg w-full px-4 py-2.5 focus:ring-0 focus:border-gray-300 h-40 resize-none" placeholder="Write your message here..." value={contactData?.message} onChange={handleOnChange} required />
                            </div>
                            <div>
